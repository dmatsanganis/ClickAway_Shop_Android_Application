                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            for (DataSnapshot order_snapshot : snapshot.getChildren()){
                                                ...
                                                try {
                                                    ...
                                                    if (order.getUser().getEmail().equals(currentUser.getEmail()) && !order.getCompleted() && ending_order_time.before(new Date())){
                                                        orders.add(order);
                                            ...
                                            if (orders.isEmpty()){
                                                message.setText(getString(R.string.expiredEmpty));
                                                message.setVisibility(View.VISIBLE);
                                            } else {
                                                message.setVisibility(View.GONE);
                                            }
                                            adapter.setOrders(orders, stores_of_orders, 1);
                                        }
                                        @Override
